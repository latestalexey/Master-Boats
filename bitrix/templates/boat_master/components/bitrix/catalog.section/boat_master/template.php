...
if (!empty($arResult['ITEMS'])) {
    ...
    <div class="bx_catalog_list_home col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? /* echo $templateData['TEMPLATE_CLASS']; */ ?> list-group">


        <?//echo "<pre>"; print_r($arResult); echo "</pre>";?>


        <h1 class="title-catalog"><?=$arResult['NAME']?></h1>
        ...
        foreach ($arResult['ITEMS'] as $key => $arItem) {
            ...
            <div class="<? /* echo($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); */ ?> item  col-xs-12 col-sm-6 col-md-4 thumbnail">


                <h4 class="bx_catalog_item_title list-group-item-heading">
                ...
                <div class="bx_catalog_item_container caption" id="<? echo $strMainID; ?>">


                    <div id="<?=$arItem['ID']?>_carousel" class="carousel slide" data-interval="0" data-ride="carousel">
                        <!-- Слайды карусели -->
                        <div class="carousel-inner">
                            <!-- Слайды создаются с помощью контейнера с классом item, внутри которого помещается содержимое слайда -->
                            <div class="active item">
                                <a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                                   class="bx_catalog_item_images group list-group-image"
                                   ...
                                   title="<? echo $imgTitle; ?>">
                                    ...
                                    <? if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']) { ?>
                                        ...
                                        <div id="<? echo $arItemIDs['DSC_PERC']; ?>" class="bx_stick_disc right bottom"
                                             style="display:<? echo(0 < $minPrice['DISCOUNT_DIFF_PERCENT'] ? '' : 'none'); ?>;">
                            ...
                            <div class="item">
                                <? if ($arItem['SECOND_PICT']) { ?>
                                    ...
                                    !empty($arItem['PREVIEW_PICTURE_SECOND'])
                                        ...
                                        if ($arItem['LABEL']) {
                                            ?>
                                            <div id="<? echo $arItemIDs['SECOND_STICKER_ID']; ?>" class="bx_stick average left top"
                                                 title="<? echo $arItem['LABEL_VALUE']; ?>"><? echo $arItem['LABEL_VALUE']; ?></div>
                                            <?
                                        }
                                        ?>
                            ...
                            <!-- Слайд №3 -->
                            <!--<div class="item">
                                <img class="group list-group-image" src="images/products/Apache220.png" alt=""/>
                            </div>-->
                        </div>
                        <!-- Навигация для карусели -->
                        <!-- Кнопка, осуществляющая переход на предыдущий слайд с помощью атрибута data-slide="prev" -->
                        <a class="carousel-control left" href="#<?=$arItem['ID']?>_carousel" data-slide="prev">
                            <span class="glyphicon caruselArrowLeft"></span>
                        </a>
                        <!-- Кнопка, осуществляющая переход на следующий слайд с помощью атрибута data-slide="next" -->
                        <a class="carousel-control right" href="#<?=$arItem['ID']?>_carousel" data-slide="next">
                            <span class="glyphicon glyphicon caruselArrowRight"></span>
                        </a>

                        <!-- Индикаторы для карусели -->
                        <ol class="carousel-indicators">
                            <!-- Перейти к 0 слайду карусели с помощью соответствующего индекса data-slide-to="0" -->
                            <li data-target="#<?=$arItem['ID']?>_carousel" data-slide-to="0" class="active"></li>
                            <!-- Перейти к 1 слайду карусели с помощью соответствующего индекса data-slide-to="1" -->
                            <li data-target="#<?=$arItem['ID']?>_carousel" data-slide-to="1"></li>
                            <!-- Перейти к 2 слайду карусели с помощью соответствующего индекса data-slide-to="2" -->
                            <!--<li data-target="#myCarousel" data-slide-to="2"></li>-->

                            <a href="#" class="button3d">3D модель</a>
                        </ol>
                ...
                if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) { ?>
                    <div class="charContaner">
                        <div class="title"><?= GetMessage("CT_BCS_TPL_MESS_CHARACTERISTICS"); ?></div>
                <!-- Характеристики товара №1 -->
                    <? if (isset($arItem['DISPLAY_PROPERTIES']) && !empty($arItem['DISPLAY_PROPERTIES'])) { ?>
                    <div class="bx_catalog_item_articul #1">
                        ...
                        <? foreach ($arItem['DISPLAY_PROPERTIES'] as $arOneProp) { ?>
                            ...
                            <li>
                                <div class="name"><? echo $arOneProp['NAME']; ?></div>
                                <div class="val">
                            <? echo(
                ...
                <? } else { ?>
                    ...
                    if ($boolShowProductProps || $boolShowOfferProps) {
                        ?>
                        <div class="bx_catalog_item_articul #2">
                            <?
                ...
                <? } ?>
                    ...
                    $compareBtnMessage = ($arParams['MESS_BTN_COMPARE'] != '' ? $arParams['MESS_BTN_COMPARE'] : GetMessage('CT_BCS_TPL_MESS_BTN_COMPARE')); // кнопка сравнить

                    ?>


                    <div class="bx_catalog_item_price">
                        <div class="RRS"><?= GetMessage("CT_BCS_TPL_MESS_PRICE"); ?> </div>
                        ...
                        <div class="bx_catalog_item_controls">
                            ...
                            <? if ($arItem['CAN_BUY']) {
                                ...
                                <? if ($arParams['DISPLAY_COMPARE']) { ?>
                                    ...
                                    <a id="<? echo $arItemIDs['COMPARE_LINK']; ?>" class="btn btn-default customButton 2 555"
                                ...
                                if ($showSubscribeBtn):
                                    $APPLICATION->includeComponent('bitrix:catalog.product.subscribe', '',
                                        array(
                                            ...
                                            'BUTTON_CLASS' => 'btn btn-default customButton',
                                    ...
                                    <div class="bx_catalog_item_controls_blocktwo"><?
                                        if ($arParams['DISPLAY_COMPARE']) { ?>
                                            <a id="<? echo $arItemIDs['COMPARE_LINK']; ?>"
                                               class="btn btn-default customButton 2"
                                               href="javascript:void(0)"><? echo $compareBtnMessage; ?></a>
                                        <? } ?>
                                    </div>
                                <? }
                                    ...
                                    <a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="btn btn-default customButton buy"
                    ...
                    $canBuy = $arItem['JS_OFFERS'][$arItem['OFFERS_SELECTED']]['CAN_BUY']; ?>
                        ...
                        <div class="bx_catalog_item_controls no_touch">
                            ...
                            <div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>"
                                 class="bx_catalog_item_controls_blocktwo catalog_item_controls text-uppercase"
                                ...
                                <a id="<? echo $arItemIDs['COMPARE_LINK']; ?>" class="btn btn-default customButton"
                                   href="javascript:void(0)"><? echo $compareBtnMessage; ?></a>
                        ...
                        <div class="bx_catalog_item_controls no_touch">
                            <a class="btn btn-default customButton 2" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><?
