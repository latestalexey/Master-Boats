...
<div class="bx-content bx_item_detail <? echo $templateData['TEMPLATE_CLASS']; ?>" id="<? echo $arItemIDs['ID']; ?>">
    ...
    <div class="row">
        ...
        <div class="bx_item_container">
            <div class="bx_lt lt_temp col-md-6">


                <div class="bx_item_slider item_slider_temp" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
                        ...
                        <div class="bx_bigimages_imgcontainer">
                            ...
                            if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']) {
                                if (!isset($arResult['OFFERS']) || empty($arResult['OFFERS'])) {
                                    ...
                                    ?>
                                    <div class="bx_stick_disc right bottom"
                                         id="<? echo $arItemIDs['DISCOUNT_PICT_ID'] ?>"
                    ...
                    if ($arResult['SHOW_SLIDER']) {
                        if (!isset($arResult['OFFERS']) || empty($arResult['OFFERS'])) {
                            ...
                            <div class="<? echo $strClass; ?>" id="<? echo $arItemIDs['SLIDER_CONT_ID']; ?>">
                                ...
                                <div class="bx_slider_scroller_container bx_slider_scroller_container_temp">
                                    <div class="bx_slide bx_slide_temp">
                                        <ul style="width: <? echo $strWidth; ?>;"
                                            ...
                                            foreach ($arResult['MORE_PHOTO'] as &$arOnePhoto) {
                                                ...
                                                <span class="cnt cnt_temp"><span class="cnt_item"
                            ...
                            foreach ($arResult['OFFERS'] as $key => $arOneOffer) {
                                ...
                                //    $strOneWidthTMP = (100 / $arOneOffer['MORE_PHOTO_COUNT']) . '%';
                                //    $strOneWidth = $strOneWidthTMP + 22 . '%';

                                //  $strWidth = (20 * $arOneOffer['MORE_PHOTO_COUNT']) . '%';

                                    $strWidthTMP = (20 * $arOneOffer['MORE_PHOTO_COUNT']) . '%';
                                    $strWidth = $strWidthTMP - 16 . '%';
                                    $strSlideStyle = '';
                                } else {
                                    $strClass = 'bx_slider_conteiner';
                                    $strOneWidth = '20%';
...
<? if (3 < $arOneOffer['MORE_PHOTO_COUNT']) {
    $styleCSS = 'class="slide-preview-ico"';
}?>

                                    <div class="bx_slider_scroller_container bx_slider_scroller_container_temp">
                                        <div class="bx_slide" style="width: <? echo $strWidth; ?>;" >
                                            <ul
                                                id="<? echo $arItemIDs['SLIDER_LIST_OF_ID'] . $arOneOffer['ID']; ?>">
                                                <?
                                                foreach ($arOneOffer['MORE_PHOTO'] as &$arOnePhoto) {
                                                    ?>
                                                    <li <?=$styleCSS ?> data-value="<? echo $arOneOffer['ID'] . '_' . $arOnePhoto['ID']; ?>"
                                                        style="width: <? echo $strOneWidth; ?>; padding-top: 20%;">
                                                    <span class="cnt cnt_temp">
                                                        <span class="cnt_item"
                                                                                     style="background-image:url('<? echo $arOnePhoto['SRC']; ?>');"></span></span>
                                                    </li>
                                                    <?
            ...
            <div class="bx_rt rt_temp col-md-6">
                <?
                ...
                <div class="item_price">
                    ...
                    <div class="item_current_price"
                         id="<? echo $arItemIDs['PRICE']; ?>"><? echo $minPrice['PRINT_DISCOUNT_VALUE']; ?></div>
                    <?/*
                    if ($arParams['SHOW_OLD_PRICE'] == 'Y') {
                        ?>
                        <div class="item_economy_price" id="<? echo $arItemIDs['DISCOUNT_PRICE']; ?>"
                             style="display: <? echo($boolDiscountShow ? '' : 'none'); ?>"><? echo($boolDiscountShow ? GetMessage('CT_BCE_CATALOG_ECONOMY_INFO', array('#ECONOMY#' => $minPrice['PRINT_DISCOUNT_DIFF'])) : ''); ?></div>
                        <?
                    }
                    */?>
                </div>
                ...
                <div class="item_info_section">
                    ...
                    if ($arParams['USE_PRODUCT_QUANTITY'] == 'Y') {
                        ...
                        */?>
                        ...
                        <div class="count_temp"><? echo GetMessage('CATALOG_QUANTITY'); ?></div>
                  ...
                  id="<? echo $arItemIDs['QUANTITY_MEASURE']; ?>"><? echo(isset($arResult['CATALOG_MEASURE_NAME']) ? $arResult['CATALOG_MEASURE_NAME'] : ''); ?></span>
                        ...
                        <div class="item_buttons vam">
                            ...
                            <? if ($arParams['DISPLAY_COMPARE']) {
                                ?>
                                <span class="item_buttons_counter_block">
			<a href="javascript:void(0);" class=" btn btn-default customButton bx_cart"
               id="<? echo $arItemIDs['COMPARE_LINK']; ?>"><? echo $compareBtnMessage; ?></a>
		</span>
                            <? } ?>
...
if ($showBuyBtn) {
    ?>
    <a href="javascript:void(0);" class="bx_big bx_bt_button bx_cart btn btn-default customButton buy"
...
if ($showAddBtn) {
    ?>
    <a href="javascript:void(0);" class="bx_big bx_cart btn btn-default customButton buy"
		...
		<? if ($arParams['DISPLAY_COMPARE']) {
            ?><a href="javascript:void(0);" class="bx_big bx_bt_button_type_2 bx_cart"
                ...
                if (!empty($arResult['DISPLAY_PROPERTIES']) || $arResult['SHOW_OFFERS_PROPS']) {
                    ?>
                    <div class="item_info_section item_info_section_temp">
                        <?
                        if (!empty($arResult['DISPLAY_PROPERTIES'])) {
                            ...
                            <ul class="charList">
                                ...
                                foreach ($arResult['DISPLAY_PROPERTIES'] as &$arOneProp) {
                                    ?>
                                    <li>
                                        <div class="name"><span class="char"><? echo $arOneProp['NAME']; ?></span></div>

                                        <div class="val"><span class="char"><?
                                                echo(
                ...
                if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS']) && !empty($arResult['OFFERS_PROP'])) {
                    $arSkuProps = array();
                    ?>
                    <div class="item_info_section scu_detail" style="padding-right:150px;"
            ...
            <div class="bx_md md_temp col-md-12">
                <div class="item_info_section">
                    <?
                    if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS'])) {
...
?>
            ...
            <div class="bx_rb md_temp col-md-12">
                <div class="item_info_section">
                    <?
            ...
            <div class="bx_lb md_temp col-md-12">
                <div class="tac ovh">
                </div>
