        ...
        <ul>
            <? if ($arResult["bDescPageNumbering"] === true): ?>
                ...
                <? if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]): ?>
                    ...
                    <? else: ?>
                        <? if (($arResult["NavPageNomer"] + 1) == $arResult["NavPageCount"]): ?>
                            <li class="bx-pag-prev"><a href="<?= $arResult["sUrlPath"] ?><?= $strNavQueryStringFull ?>"><? echo GetMessage("round_nav_back") ?></a>
                            </li>
                        <? else: ?>
                            <li class="bx-pag-prev"><a
                                        href="<?= $arResult["sUrlPath"] ?>?<?= $strNavQueryString ?>PAGEN_<?= $arResult["NavNum"] ?>=<?= ($arResult["NavPageNomer"] + 1) ?>"><? echo GetMessage("round_nav_back") ?></a>
                            </li>
                        <? endif ?>
                ...
                while ($arResult["nStartPage"] >= $arResult["nEndPage"] + 1):
                    ...
                    <li class="bx-active"><?= $NavRecordGroupPrint ?></li>
                <? else:?>
                    <li class=""><a
                ...
                <? if ($arResult["NavPageNomer"] > 1): ?>
                    ...
                    <li class="bx-pag-next"><a
                                href="<?= $arResult["sUrlPath"] ?>?<?= $strNavQueryString ?>PAGEN_<?= $arResult["NavNum"] ?>=<?= ($arResult["NavPageNomer"] - 1) ?>"><? echo GetMessage("round_nav_forward") ?></a>
                    </li>
                <? else: ?>
                    <? if ($arResult["NavPageCount"] > 1): ?>
            ...
            <? else: ?>
                ...
                while ($arResult["nStartPage"] <= $arResult["nEndPage"] - 1):
                    ?>
                    <? if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
                    <li class="bx-active"><?= $arResult["nStartPage"] ?></li>
                <? else:?>
                    <li class=""><a
                ...
                <? else: ?>
                    <? if ($arResult["NavPageCount"] > 1): ?>
                        <li class="bx-active"><?= $arResult["NavPageCount"] ?></li>
                    <? endif ?>
                    <li class="bx-pag-next"><? echo GetMessage("round_nav_forward") ?></li>
                <? endif ?>
            <? endif ?>
