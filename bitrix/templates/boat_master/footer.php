...
<footer>
    <div class="container">
        <div class="row">
            <div class="address col-xs-12 col-sm-6 col-md-3"><? $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/address.php"), false); ?></div>
            <div class="time col-xs-12 col-sm-6 col-md-3"><? $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/worktime.php"), false); ?></div>
            <div class="mail col-xs-12 col-sm-6 col-md-3"><? $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/mail.php"), false); ?></div>
            <div class="col-xs-12 col-sm-6 col-md-3"><? $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/footer_menu.php"), false); ?>
            </div>
        </div>
    </div>
</footer>
    ...
    <div class="bx-footer-bottomline">
        <div class="bx-footer-section container">
            ...
            <div class="col-sm-6 bx-up"><a href="javascript:void(0)" data-role="eshopUpButton"><i
                            class="fa fa-caret-up"></i> <?/*= GetMessage("FOOTER_UP_BUTTON") */?></a></div>
        </div>
    </div>
